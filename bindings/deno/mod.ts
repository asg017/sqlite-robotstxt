...
try {
  ...
  if (customPath) path = customPath;
    ...
    path = await download({
      url: {
        darwin: {
          aarch64: `${BASE}/sqlite-robotstxt-v${meta.version}-deno-darwin-aarch64.robotstxt0.dylib`,
          x86_64: `${BASE}/sqlite-robotstxt-v${meta.version}-deno-darwin-x86_64.robotstxt0.dylib`,
        },
        windows: {
          x86_64: `${BASE}/sqlite-robotstxt-v${meta.version}-deno-windows-x86_64.robotstxt0.dll`,
        },
        linux: {
          x86_64: `${BASE}/sqlite-robotstxt-v${meta.version}-deno-linux-x86_64.robotstxt0.so`,
        },
      },
      suffixes: {
        darwin: "",
